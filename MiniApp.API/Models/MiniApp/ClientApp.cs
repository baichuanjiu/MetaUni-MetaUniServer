...
namespace MiniApp.API.Models.MiniApp
{
    ...
    {
        public ClientApp(string? id, string name, string avatar, string description, string backgroundImage, string routingURL, string? URL, double trendingValue, string minimumSupportVersion)
        {
            Id = id;
            Name = name;
            Avatar = avatar;
