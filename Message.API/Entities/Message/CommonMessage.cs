...
namespace Message.API.Entities.Message
{
    ...
    public class CommonMessage
    {
        ...
        public bool IsImageMessage { get; set; } = false; //是否是带有图片的消息
        ...
        public string? MessageImage { get; set; } //消息附带的图片，以JSON形式存储的字符串数组，数组内容为图片资源存储地址
        public string? MessageVoice { get; set; } //语音消息资源存储地址
